...
def banner():
	...
	r'   $$ |  $$ |  $$ |      $$ |  $$ $$ |  $$ $$ |\$  /$$ $$ |  $$ |',
	r'   $$ |  $$$$$$$  |      $$$$$$$  |$$$$$$  $$ | \_/ $$ $$$$$$$  |',
	r'   \__|  \_______/       \_______/ \______/\__|     \__\_______/ ',
    r'                                                                 ']
                                                                 
                                                                 
	for i in logo:
		print(random.choice(banner_colors),i)
	print(f'            {blue}Developer: {green}Technical Badhon {white}| {blue}Country: {green}BD            ')
	print('')
...
def goodbye():
	...
	print('Find me at: https://facebook.com/technicalbadhon'.center(62, ' '))
	exit()
